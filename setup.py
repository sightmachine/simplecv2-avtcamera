...
import simplecv_avtcamera


setup(name="simplecv2-avtcamera",
      version=simplecv_avtcamera.__version__,
      description="simplecv plugin that provides AVT Camera",
      ...
      entry_points={
          'simplecv.factory': [
              'AVTCamera = simplecv_avtcamera.avt_camera:AVTCamera'
          ]
      })
